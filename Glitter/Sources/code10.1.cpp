...
// use very simple radius and glfwGetTime() to control the movement of camera.
...
int main()
{
    ...
    while(!glfwWindowShouldClose(window))
    {
        ...
        model = glm::rotate(model, (GLfloat)glfwGetTime() * 0.0f, glm::vec3(1.0f, 0.8f, 0.5f));
        //transform = glm::scale(transform, glm::vec3(0.5f, 0.5f, 0.5f));
        GLfloat radius = 2.0f;
        GLfloat camx = sin(glfwGetTime()) * radius;
        GLfloat camz = cos(glfwGetTime()) * radius;
        view = glm::lookAt(glm::vec3(camx, 0.0f, camz), glm::vec3(0.5f, 0.5f, 0.0f), glm::vec3(0.0f, 1.0f, 0.0f));
